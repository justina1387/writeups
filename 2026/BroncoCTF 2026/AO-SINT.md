...
![alt text](docs/AO-SINT/image.png)
...
![alt text](docs/AO-SINT/image-1.png)
...
![alt text](docs/AO-SINT/image-2.png)
![alt text](docs/AO-SINT/image-3.png)

3. **Ierochos** is the only possible island behind the two. (Uppercase i, by the way, not L)

![alt text](docs/AO-SINT/image-5.png)
...
![alt text](docs/AO-SINT/image-6.png)
Name: Port Mistral

## 3N
![alt text](docs/AO-SINT/location3N.png)
1. Reverse-search the image (and ignore the AI for now).
![alt text](docs/AO-SINT/image-7.png)
...
![alt text](docs/AO-SINT/image-9.png)
...
![alt text](docs/AO-SINT/image-10.png)
...
![alt text](docs/AO-SINT/image-17.png)
